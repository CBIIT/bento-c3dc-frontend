window.injectedEnv = {
  ...
  REACT_APP_BACKEND_API: 'https://c3dc-dev.bento-tools.org/v1/graphql/',
  REACT_APP_APPLICATION_VERSION: 'YYYY_MM_DD/HH:MM',
  REACT_APP_ABOUT_CONTENT_URL: 'https://raw.githubusercontent.com/CBIIT/bento-c3dc-frontend/develop/src/content/dev/aboutPagesContent.yaml',
  REACT_APP_FILE_SERVICE_API: 'https://c3dc-dev.bento-tools.org/api/files/',
};
