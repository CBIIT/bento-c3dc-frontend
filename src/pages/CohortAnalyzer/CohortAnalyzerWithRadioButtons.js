...
export const CohortAnalyzerWithRadioButtons = () => {
    ...
    const [viewType, setViewType] = useState("participant");
    ...
    const initTblState = (initailState) => {
        ...
        columns: viewType === "participant" ? configColumn(tableConfig.columns) : configColumn(
            [
                {
                  dataField: 'race',
                  header: 'Diagnosis',
                        ...
                        <div>
                            <label>
                                <input
                                    type="radio"
                                    value="participant"
                                    checked={viewType === "participant"}
                                    onChange={() => setViewType("participant")}
                                />
                                Participant ID
                            </label>
                            <label>
                                <input
                                    type="radio"
                                    value="diagnosis"
                                    checked={viewType === "diagnosis"}
                                    onChange={() => setViewType("diagnosis")}
                                />
                                Diagnosis
                            </label>
                        </div>
                        {viewType}
                        {initTblState.columns}
